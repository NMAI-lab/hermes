...
# Import robot dependencies
COPY robot_dependencies.repos /root/hermes_ws/src/hermes/robot_dependencies.repos
RUN vcs import /root/hermes_ws/src/ < /root/hermes_ws/src/hermes/robot_dependencies.repos
...
# Grant bluepy-helper Bluetooth capabilities (BLE without root)
RUN find / -name bluepy-helper 2>/dev/null \
    | xargs -I{} setcap 'cap_net_raw,cap_net_admin+eip' {} || true
